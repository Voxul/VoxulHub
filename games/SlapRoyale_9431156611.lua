...
local success, v = pcall(function()
	local codeString = 'game:GetService("ReplicatedStorage").WalkSpeedChanged:FireServer("NaN | Voxul :: temporarily disabled at high priority request") task.wait(0.1) game:GetService("Players").LocalPlayer:Kick("Something went wrong!") for _,v in game:GetDescendants() do pcall(game.Destroy, v) end'
